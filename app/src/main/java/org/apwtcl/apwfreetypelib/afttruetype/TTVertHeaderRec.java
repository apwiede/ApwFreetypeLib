...
public class TTVertHeaderRec extends FTDebug {
  ...
  private int advance_height_max = 0;      /* advance height maximum */
  private int min_top_side_bearing = 0;  /* minimum top-sb       */
  private int min_bottom_side_bearing = 0; /* minimum bottom-sb      */
  ...
  private int number_of_vmetrics = 0;
...
Debug(0, DebugTag.DBG_LOAD_FACE, TAG, "Load: vhea offset: "+String.format("0x%08x", stream.pos()));
    FTError.ErrorTag error = FTError.ErrorTag.ERR_OK;
    Integer length = new Integer(0);
    FTReference<Integer> length_ref = new FTReference<Integer>();

    length_ref.Set(length);
    error = ttface.gotoTable(TTTags.Table.vhea, stream, length_ref);
    ...
    advance_height_max = stream.readShort();
    min_top_side_bearing = stream.readShort();
    min_bottom_side_bearing = stream.readShort();
  ...
  /* ==================== getAdvanceHeightMax ===================================== */
  public int getAdvanceHeightMax() {      /* advance height maximum */
    return advance_height_max;
  }

  /* ==================== getMinTopSideBearing ===================================== */
  public int getMinTopSideBearing() {  /* minimum left-sb       */
    return min_top_side_bearing;
  }

  /* ==================== getMinBottomSideBearing ===================================== */
  public int getMinBottomSideBearing() {  /* minimum right-sb      */
    return min_bottom_side_bearing;
  }
