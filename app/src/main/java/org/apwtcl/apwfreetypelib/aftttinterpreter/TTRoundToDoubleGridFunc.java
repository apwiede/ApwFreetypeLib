...
public class TTRoundToDoubleGridFunc extends TTRoundFuncBase {
  private static int oid = 0;

  private int id;
  private static String TAG = "TTRoundToDoubleGridFunc";

  /* ==================== TTRoundToDoubleGridFunc ================================== */
  public TTRoundToDoubleGridFunc()
  {
    oid++;
    id = oid;
  }
